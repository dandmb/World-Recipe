...
@Composable
fun BottomNavGraph(navHostController: NavHostController,modifier: Modifier=Modifier,uiState: UIState,viewModel: MainViewModel){
    NavHost(navController = navHostController, startDestination = BottomBarScreen.Recipe.route,modifier){
        ...
        composable(
            ...
            RecipeDetail(imgSrc,title,summary)
        }
    }
}